...
public class E2E {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		if (driver.findElement(By.id("Div1")).getAttribute("style").contains("0.5")) // one way =opacity 1, two way= opacity=0.5
        {
      	 // System.out.println("it's enabled")
          System.out.println("it's disabled");
                //      Assert.assertTrue(false);//WE WANT TO DISABALE the round trip so it should return false
  ...
  // driver.findElement(By.cssSelector("//input[type='submit']")).click();
   // driver.findElement(By.cssSelector("input[value='Search']")).click();// passenger is selecting but search button is not working
   // driver.findElement(By.xpath("//input[@value='Search']")).click();
    // driver.findElement(By.name("ctl00$mainContent$btn_FindFlights")).click();
 //    driver.findElement(By.id("ctl00_mainContent_btn_FindFlights")).click();
   //  driver.findElement(By.xpath("//input[@id='ctl00_mainContent_btn_FindFlights']")).click();
   //driver.findElement(By.xpath("Abhipsa")).click();
  // driver.findElement(By.cssSelector("input[value='Search']")).click();
	driver.findElement(By.xpath(".//input[@id='ctl00_mainContent_btn_FindFlights']")).click();
